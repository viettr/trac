...
#'
#' @export
sparse_log_contrast_two <- function(Z, y, additional_covariates = NULL,
  ...
  Zbar_1 <- Matrix::rowMeans(Z[, 1:ncol_z1])
  Zbar_2 <- Matrix::rowMeans(Z[, (ncol_z1 + 1):(ncol_z1 + ncol_z2)])
  Z_clr <- Z
  Z_clr[, 1:ncol_z1] <- Z_clr[, 1:ncol_z1] - Zbar_1
  Z_clr[, (ncol_z1 + 1):(ncol_z1 + ncol_z2)] <-
    Z_clr[, (ncol_z1 + 1):(ncol_z1 + ncol_z2)] - Zbar_2
